 ...
 * Voici les options du menu:
    <ul><li>1   --> Négatif d'une image</li>
	    ...
	    <li>51  --> Chargement rapide de hoodoos.bmp</li>
	    <li>52  --> Chargement rapide de horseshoe.bmp</li>
	    <li>53  --> Chargement rapide de nenuphar.bmp</li>
	    <li>55  --> Chargement du fichier de votre choix</li>
	    <li>56  --> Rechargement du fichier</li>
	    <li>60  --> Enregistrement dans imagefinal.bmp</li>
	    <li>61  --> Chargement du fichier d'enregistrement</li>
	    <li>0   --> Quitter le programme</li></ul>
 *
 *
